...
public class Wallet {
	...
	public void generateKeyPair() {
		try {
			...
			keyGen.initialize(ecSpec, new SecureRandom()); // 256 bytes provides an acceptable security level
	...
	public float getBalance() {
		float total = 0;
		for (Map.Entry<String, TransactionOutput> item : WalletBean.UTXOs.entrySet()) {
