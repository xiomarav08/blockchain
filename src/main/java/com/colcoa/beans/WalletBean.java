...
public class WalletBean implements Serializable{
	...
	public void generateWallet() {		
		...
		this.publicKey = StringUtil.getStringFromKey(billeteraUsuario.getPublicKey());
		this.privateKey = StringUtil.getStringFromKey(billeteraUsuario.getPrivateKey());
	...
	public void generateBuy(ActionEvent actionEvent) {
		...
		block1.addTransaction(billeteraUsuario.sendFunds(billeteraAdmin.getPublicKey(), valorArbol));
		addBlock(block1);
		saldo = String.valueOf(billeteraUsuario.getBalance());
		saldoAdmin = String.valueOf(billeteraAdmin.getBalance());
	}
